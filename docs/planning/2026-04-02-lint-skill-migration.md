...
| **Cookbook Analyzer** | `/dev-team create-recipe-from-code <target>` | Reverse-engineer an artifact into cookbook format — codebase into cookbook recipe |
...
- Rename: `skills/analyze/` → `skills/create-recipe-from-code/`
...
- [ ] **Step 1:** Rename `skills/analyze/` directory to `skills/create-recipe-from-code/`
- [ ] **Step 2:** Update `skills/create-recipe-from-code/SKILL.md` frontmatter: `name: dev-team`, update description to mention `<target>` argument
...
6. **Renamed skills work:** Run `/dev-team create-recipe-from-code`, `/dev-team generate`, `/dev-team build` — verify they invoke correctly
